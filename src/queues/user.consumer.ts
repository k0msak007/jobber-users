import { IBuyerDocument, ISellerDocument, winstonLogger } from '@k0msak007/jobber-shared';
...
const log: Logger = winstonLogger(`${config.ELASTIC_SEARCH_URL}`, 'usersServiceCousumer', 'debug');
